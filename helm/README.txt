...
Also, your Coralogix domain and application values and your cluster name per 1-start.sh
You can change the default failure values in the opentelemetry-demo/flagd/demo.flagd.json file
...
---- Below here is default README context ----

The helm chart installs a local copy of the [OpenTelemetry Demo](https://github.com/open-telemetry/opentelemetry-demo)
